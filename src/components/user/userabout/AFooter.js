          ...
          <div class="col-md-5 offset-md-1 mb-3">
            ...
            <ul class="nav flex-column text-center">
              <li class="nav-item mb-2">
                <Link to="/user/dashboard" class="nav-link p-0 text-light">
                  Home
                </Link>
              </li>
              <li class="nav-item mb-2">
                <Link to="/user/usercontact" class="nav-link p-0 text-light">
                  Contact Us
                </Link>
              </li>
              <li class="nav-item mb-2">
                <Link to="/user/userabout" class="nav-link p-0 text-light" onClick={scrollToTop}>
                  About Us
                </Link>
              </li>
            </ul>
