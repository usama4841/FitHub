...
export default function AdminSettings() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/admin/updatepassword', {
        method: 'PUT',
        headers: {
  ...
  return (
    <div>
      <AdminNav/>
      <div className="container text-light px-5 pt-5 pb-2 mx-auto .bg-dark.bg-gradient" style={{ borderRadius: "10px" }}>
        <div className="container">
          <p className="display-5 fw-semibold text-center" style={{ color: "#ff1100" }}>Change Password</p>
          <form className="mx-auto pb-3" style={{ maxWidth: "500px" }} onSubmit={handleChangePassword}>
            <div className="mb-3">
